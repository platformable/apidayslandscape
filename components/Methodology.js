      ...
      <section className="px-2 md:px-6 lg:px-10 py-20 lg:py-24 2xl:py-32 bg-[#E1F6F8]">
        <div className="max-w-screen-lg  mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <a
              className="change-box grid gap-y-5 btn-transition text-center"
              target="_blank"
              href="/report"
            ...
            <Link
              className="change-box grid gap-y-5 btn-transition"
              href={"/report"}
            >
              <div className="flex justify-center">
                <img
              ...
              <div className=" text-white font-bold uppercase text-[18px] text-center">
                Report a bug
              </div>
            </Link>

            <Link
              className="change-box grid gap-y-5 btn-transition py-5"
              href={"/report"}
            >
              <div className="flex justify-center">
                <img
