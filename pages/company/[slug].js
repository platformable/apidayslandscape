...
{/* <section className="mobile-profile"> */}
  ...
  ${subcat.includes("Audio & Video")&& "BusinessprocessesasanAPIAPIasaProductBg-light"}
  ...
  ${subcat.includes("Marketing and Analytics")&& "VerticalAPIAbstractionsBg-light"}
  ${subcat.includes("Finance")&& "VerticalAPIAbstractionsBg-light"}
  ${subcat.includes("Smart Home and Smart Facilities")&& "VerticalAPIAbstractionsBg-light"}
  ...
  `}>{subcat}</span>
          ...
          <div className="profile-right-side bg-white p-2">
          ...
          <div className="row">
            <div className="col-md-3 p-2 border-end border-bottom">
          ...
          <div className="row">
            ...
            <div className="col-md-4 text-center p-2  border-top">
          ...
          <div className="row">
            <div className="col-md-4 text-center border-top p-2 border-end">
            ...
            <div className="col-md-4 text-center border-top p-2">
            ...
            <div className="col-md-6 text-center border-top p-2 border-end">
            ...
            <div className="col-md-6 text-center border-top p-2">
          ...
          <div className="row">
            <div className="col-md-3 text-center border-top border-end p-2">
            <div className="new-product-features-top ">
            ...
            <div className="col-md-3 text-center border-top p-2">
            <div className="new-product-features-top ">
          ...
          <div className="row mobile-charts border-top border-bottom p-5">
            <div className="col-md-9 text-center md-border-end">
   
            <div className="new-product-features-top  align-items-center mb-3">
          ...
          <div className="row">
                 ...
                 <div className="new-product-features-top text-center">
                  ...
                  <div className="new-product-features-bottom">
                  {activeTechCount? <h6 className="text-center fw-bold my-2">{activeTechCount}</h6>:<Unknown/>}
                  </div> {/* features-top */}
                 ...
                 <div className="new-product-features-top text-center">
                  ...
                  <div className="new-product-features-bottom text-center">
          ...
          <div className="row">
                 <div className="col-md-12 border-top p-3 border-bottom">
                 <div className="new-product-features-top text-center">
         ...
         <div className="row ">
               ...
               <h6><span className="badge bg-lightgreen text-black">{stage? stage:"-"}</span></h6>
                 ...
                 <div className="col-md-2 border-top p-2">
                 <div className="box-container d-flex flex-column align-items-center">
               ...
               <img src="../../apilandscape_lead_investors__60x45.png" alt="" className="md-icon my-1 px-2 align-self-center" />
                 ...
                 <div className="col-md-3 p-2 border-top">
                 <div className="box-container d-flex flex-column align-items-center">
         ...
         <div className="row">
                 ...
                 <div className="col-md-3 border-end border-top p-3">
                 <div className="box-container d-flex flex-column align-items-center">
               ...
               <img src="../../apilandscape_acquisition_price__60x45.png" alt="" className="md-icon my-1 px-2 align-self-center" />
                 ...
                 <div className="col-md-2 border-end border-top p-3">
               ...
               <img src="../../apilandscape_money_raised_at_IPO_60x45.png" alt="" className="md-icon my-1 px-2 align-self-center" />
                 ...
                 <div className="col-md-3  border-top p-3">
                 <div className="box-container d-flex flex-column align-items-center">
