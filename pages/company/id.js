           ...
           <div className="founded">
             <div className="founded-top">
               <div className="founded-top-left">
                 <div className="icon">
                    <img src="../../apilandscape__founded_in_40x40.png" alt="Founded in icon" className="icon" />
                 </div> {/* icon */}
               ...
               <div className="founded-top-left">
                 <div className="icon">
                    <img src="../../apilandscape__founder 40x40.png" alt="Founders icon" className="icon" />
                 </div> {/* icon */}
               ...
               <div className="founded-top-left">
                 <div className="icon">
                    <img src="../../apilandscape__headquarter_40x40.png" alt="Headquarte icon" className="icon" />
                 </div> {/* icon */}
                 <div className="foundedIn-text ml-2">
